...
public class OkHttpUtils {
    ...
    public static void main(String[] args) {
        String url = "http://192.168.159.111:9090/api/v1/query";
        Map<String, Object> map = new HashMap<>();
        map.put("query", "rate(canal_instance_transactions{destination=\"example\"}[2m])");
        Result result = doGet(url, map, null);
    ...
    public static Result call(String url, Request.Builder builder) {
